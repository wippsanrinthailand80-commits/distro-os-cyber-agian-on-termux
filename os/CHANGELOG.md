...
- **MEDIUM**: proot/main.c — fixed version string mismatch (1.0.0 → 2.5.3)
...
- **LOW**: All version strings unified to v2.5.3 across every file

### Changed
- All edition version strings aligned to `2.5.3`
