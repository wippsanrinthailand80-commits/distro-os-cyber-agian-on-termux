...
[![Platform](https://img.shields.io/badge/platform-Termux%20%7C%20Linux%20%7C%20macOS-00d4ff?style=flat-square)](https://github.com/wippsanrinthailand80-commits/phantomsec-distro-feel)
...
```bash
bash <(curl -sL https://raw.githubusercontent.com/wippsanrinthailand80-commits/phantomsec-distro-feel/main/install.sh)
```
...
# Or manually
git clone https://github.com/wippsanrinthailand80-commits/phantomsec-distro-feel
cd phantomsec-distro-feel
bash install.sh
phantomsec
```
